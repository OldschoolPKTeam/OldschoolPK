...
class Npc private constructor(val id: Int, world: World, val spawnTile: Tile) : Pawn(world) {
    ...
    /**
     * This flag indicates if the npc faces other entities when being clicked.
     */
    var faceEntities =  true

    /**
     * This flag indicates whether the npc will ever use combat.
     */
    var passive = false
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (spawnTile != other.spawnTile) return false

        return true
    }

    override fun hashCode(): Int {
        return Objects.hash(id, index, spawnTile)
    }
