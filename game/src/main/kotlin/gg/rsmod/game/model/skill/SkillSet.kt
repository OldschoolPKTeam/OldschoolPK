...
class SkillSet(val maxSkills: Int) {
    ...
    val skills = Array(maxSkills) { index -> Skill(index) }
     ...
     * [getMaxLevel] - [value].
     */
    fun decrementCurrentLevel(skill: Int, value: Int, capped: Boolean) =
     ...
     * [getMaxLevel].
     */
    fun incrementCurrentLevel(skill: Int, value: Int, capped: Boolean) =
