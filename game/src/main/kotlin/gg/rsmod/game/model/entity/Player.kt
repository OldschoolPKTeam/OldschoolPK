...
open class Player(world: World) : Pawn(world) {
    ...
    /**
     * The player's [java.net.SocketAddress], if they have one. If this player doesn't
     * have an ip address then it should default to a uuid.
     */
    var ipAddress = ""
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (loginUsername != other.loginUsername) return false
