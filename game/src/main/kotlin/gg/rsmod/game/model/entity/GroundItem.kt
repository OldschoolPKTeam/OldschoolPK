 ...
 */
class GroundItem private constructor(val item: Int, var amount: Int, internal var ownerUID: PlayerUID?, val despawns: Boolean = true) : Entity() {

    constructor(item: Int, amount: Int, tile: Tile, owner: Player? = null, despawns: Boolean) : this(item, amount, owner?.uid, despawns) {
        this.tile = tile
    }

    constructor(item: Int, amount: Int, tile: Tile, owner: Player? = null) : this(item, amount, owner?.uid, true) {
        this.tile = tile
    }
