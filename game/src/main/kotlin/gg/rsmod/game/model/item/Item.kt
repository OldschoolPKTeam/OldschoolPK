...
class Item(val id: Int, var amount: Int = 1) {
    ...
    fun removeAttr(attribute: ItemAttribute) = attr.remove(attribute)
    ...
    /**
     * @return an [Item] that is the same except there will be no attributes.
     */
    fun withoutAttributes(): Item {
