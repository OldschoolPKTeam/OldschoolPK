...
enum class LockState {
    ...
    /**
     * Does a full lock, but blocks animation
     */
    FULL_WITH_ANIMATION_BLOCKED;
    ...
    fun canAnimate(): Boolean = when(this) {
        FULL_WITH_ANIMATION_BLOCKED -> false
        else -> true
    }

    fun canUseCommand(): Boolean = when(this) {
        DELAY_ACTIONS -> false
        FULL_WITH_ITEM_INTERACTION -> false
        FULL_WITH_DAMAGE_IMMUNITY -> false
        FULL_WITH_LOGOUT -> false
        FULL -> false
        FULL_WITH_ANIMATION_BLOCKED -> false
        else -> true
    }
