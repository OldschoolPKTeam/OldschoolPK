...
data class NpcCombatDef(
        val hitpoints: Int, val stats: MutableList<Int>, val attackSpeed: Int, val attackAnimation: Int,
        ...
        val venomImmunity: Boolean, val slayerXp: Double,
    ...
    companion object {
        ...
        val DEFAULT = NpcCombatDef(
                hitpoints = DEFAULT_HITPOINTS, stats = mutableListOf(1, 1, 1, 1, 1),
