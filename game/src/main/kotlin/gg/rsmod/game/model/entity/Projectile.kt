...
class Projectile private constructor(val targetPawn: Pawn?, val targetTile: Tile,
    ...
    class Builder : Cloneable {
        ...
        public override fun clone(): Builder {
            val builder = Builder()
            builder.start = start
            builder.targetPawn = targetPawn
            builder.targetTile = targetTile
            builder.gfx = gfx
            builder.startHeight = startHeight
            builder.endHeight = endHeight
            builder.angle = angle
            builder.steepness = steepness
            builder.delay = delay
        ...
        fun build(): Projectile {
            ...
            if (lifespan == -1) {
                lifespan = start.getIntDistance(target) * 5
            }
