...
object PawnPathAction {
    ...
    suspend fun walkTo(
            ...
            lineOfSight: Boolean,
            suspendUntilPathCompleted: Boolean = true
    ): Boolean {
        ...
        if (suspendUntilPathCompleted) {
            while (!pawn.tile.sameAs(route.tail)) {
                // TODO: This makes no sense, targetTile = target.tile and it's immutable..?
